<script>
  ...
  import { getDashboardStatsByBranch } from '$lib/supabase-helpers.js';
  ...
  const loadData = async () => {
    try {
      ...
      console.log(`🔄 Loading dashboard stats for branch: ${currentBranch} (ID: ${branchId})`);
      ...
      console.log(`⚡ Branch dashboard stats loaded in ${loadTime}ms`);
      ...
      console.log('📊 Branch dashboard stats loaded successfully:', {
        branch: currentBranch,
        branchId: branchId,
        totalBookings: safeStats.totalBookings,
        totalLeads: safeStats.totalLeads,
        totalUmrahBookings: safeStats.totalUmrahBookings,
        totalOutboundBookings: safeStats.totalOutboundBookings
      });
